    ...
    interface Compiler with
        ...
        member this.GetInlineExpr(memberUniqueName) =
            ...
            | None ->
                ...
                | None ->
                        { Args = []
                          Body = Fable.Value (Fable.ValueKind.UnitConstant, None)
                          FileName = "GetInlineExpr"
                          GenericArgs = []
                          ScopeIdents = Set.empty }
//                        Unchecked.defaultof<_> // ("Cannot find inline member: " + memberUniqueName)
